                        ...
                        {sections.map(section => {
                            ...
                            return (
                                <Link
                                    ...
                                    <div
                                        className={`absolute -right-4 -top-4 h-24 w-24 rounded-full bg-gradient-to-br ${section.gradient} opacity-10 transition-all duration-300 group-hover:opacity-20`}></div>
                                    <div
                                        className={`absolute -bottom-4 -left-4 h-16 w-16 rounded-full bg-gradient-to-br ${section.gradient} opacity-5 transition-all duration-300 group-hover:opacity-15`}></div>
                                </Link>
                            );
                        })}
                    </div>
