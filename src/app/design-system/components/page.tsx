...
export default function ComponentsPage() {
    ...
    const [activeCategory, setActiveCategory] = useState<
        'buttons' | 'cards' | 'navigation' | 'layout'
    >('buttons')
    ...
    const componentCategories = [
        ...
        },
        {
            ...
            description: 'องค์ประกอบโครงสร้างหน้า',
            components: [
                { name: 'Header', status: 'planned', path: '#' },
                { name: 'Footer', status: 'planned', path: '#' },
                { name: 'Slider', status: 'planned', path: '#' },
                { name: 'Container', status: 'planned', path: '#' },
            ],
        },
    ]
                    ...
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                        <div className="rounded-2xl border border-white/20 bg-white/70 p-6 shadow-xl shadow-gray-500/10 backdrop-blur-sm">
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    <h3 className="text-lg font-semibold text-gray-900">16</h3>
                        ...
                        <div className="rounded-2xl border border-white/20 bg-white/70 p-6 shadow-xl shadow-gray-500/10 backdrop-blur-sm">
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    <h3 className="text-lg font-semibold text-gray-900">14</h3>
