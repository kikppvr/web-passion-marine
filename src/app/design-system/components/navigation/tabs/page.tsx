...
const TabsPage: React.FC = () => {
    ...
    const sampleContent2 = (
        <div style={{ padding: "20px" }}>
            <h3>Tab Content 2</h3>
            <p>
                This is the content for the second tab. It can contain forms, lists, or any other
                content.
            </p>
            <ul>
                <li>List item 1</li>
    ...
    return (
        <div style={{ padding: "40px", maxWidth: "800px", margin: "0 auto" }}>
            ...
            <section style={{ marginBottom: "40px" }}>
                <h2>Default Tabs</h2>
                <Tabs items={tabItems} defaultActiveTab='tab1' onTabChange={handleTabChange} />
            </section>

            {/* Underline Variant */}
            <section style={{ marginBottom: "40px" }}>
                <h2>Underline Variant</h2>
                <Tabs items={tabItems} variant='underline' defaultActiveTab='tab2' />
            </section>

            {/* Pills Variant */}
            <section style={{ marginBottom: "40px" }}>
                <h2>Pills Variant</h2>
                <Tabs items={tabItems} variant='pills' defaultActiveTab='tab1' />
            </section>

            {/* Small Size */}
            <section style={{ marginBottom: "40px" }}>
                <h2>Small Size</h2>
                <Tabs items={tabItems.slice(0, 3)} size='sm' defaultActiveTab='tab1' />
            </section>

            {/* Large Size */}
            <section style={{ marginBottom: "40px" }}>
                <h2>Large Size</h2>
                <Tabs items={tabItems.slice(0, 3)} size='lg' defaultActiveTab='tab1' />
            </section>
            ...
            <section style={{ marginTop: "60px" }}>
                ...
                <div style={{ backgroundColor: "#f5f5f5", padding: "20px", borderRadius: "8px" }}>
                    ...
                    <ul>
                        <li>
                            <strong>items</strong>: TabItem[] - Array of tab items
                        </li>
                        <li>
                            <strong>defaultActiveTab</strong>: string - ID of the initially active
                            tab
                        </li>
                        <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <strong>label</strong>: string - Display text
                        </li>
                        <li>
                            <strong>content</strong>: React.ReactNode - Tab content
                        </li>
                        <li>
                            <strong>disabled</strong>: boolean - Whether tab is disabled
                        </li>
                    </ul>
                </div>
            </section>
